...
public class AuditEventPublisher {
    ...
    public void publish(String body, Instant startProcessing, Instant endProcessing, int statusCode){
        ...
        dataMap.put("host", event.getHeader("host"));
        dataMap.put("email-agent", event.getHeader("User-Agent"));
    ...
    //  Content-Length: The length of the event body in bytes.
    //  Content-Type: The media type of the event body.
